...
module multi_param_agents_3
       ...
       []   a0 = 1 & a1 = 2 & a2 = 2 -> ((low<1 & 1<=high) ? qmin : qmax) : (a0'= 1) & (a1'= 1) & (a2'= 2) + 1-((low<1 & 1<=high) ? qmin : qmax):(a0'= 1) & (a1'= 2) & (a2'= 0);
       []   a0 = 1 & a1 = 1 & a2 = 2 -> ((low<2 & 2<=high) ? qmin : qmax) : (a0'= 1) & (a1'= 1) & (a2'= 1) + 1-((low<2 & 2<=high) ? qmin : qmax):(a0'= 1) & (a1'= 1) & (a2'= 0);

       // some ones, some twos, some zeros transitions
       []   a0 = 1 & a1 = 2 & a2 = 0 -> ((low<1 & 1<=high) ? qmin : qmax) : (a0' = 1) & (a1' = 1) & (a2' = 0) + 1-((low<1 & 1<=high) ? qmin : qmax): (a0' = 1) & (a1' = 0) & (a2' = 0);
