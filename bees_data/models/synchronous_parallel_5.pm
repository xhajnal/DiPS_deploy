...
module bees_5
       ...
       []   a0 = 1 & a1 = 2 & a2 = 2 & a3 = 2 & a4 = 2 -> 1.0*(1-q)*(1-q)*(1-q)*(1-q): (a0'=1) & (a1'=0) & (a2'=0) & (a3'=0) & (a4'=0) + 4.0*q*(1-q)*(1-q)*(1-q): (a0'=1) & (a1'=1) & (a2'=0) & (a3'=0) & (a4'=0) + 6.0*q*q*(1-q)*(1-q): (a0'=1) & (a1'=1) & (a2'=1) & (a3'=0) & (a4'=0) + 4.0*q*q*q*(1-q): (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=0) + 1.0*q*q*q*q: (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=1);
       []   a0 = 1 & a1 = 1 & a2 = 2 & a3 = 2 & a4 = 2 -> 1.0*(1-q)*(1-q)*(1-q): (a0'=1) & (a1'=1) & (a2'=0) & (a3'=0) & (a4'=0) + 3.0*q*(1-q)*(1-q): (a0'=1) & (a1'=1) & (a2'=1) & (a3'=0) & (a4'=0) + 3.0*q*q*(1-q): (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=0) + 1.0*q*q*q: (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=1);
       []   a0 = 1 & a1 = 1 & a2 = 1 & a3 = 2 & a4 = 2 -> 1.0*(1-q)*(1-q): (a0'=1) & (a1'=1) & (a2'=1) & (a3'=0) & (a4'=0) + 2.0*q*(1-q): (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=0) + 1.0*q*q: (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=1);
       []   a0 = 1 & a1 = 1 & a2 = 1 & a3 = 1 & a4 = 2 -> 1.0*(1-q): (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=0) + 1.0*q: (a0'=1) & (a1'=1) & (a2'=1) & (a3'=1) & (a4'=1);
