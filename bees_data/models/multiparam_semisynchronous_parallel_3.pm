...
module multiparam_bees_3
       ...
       []   a0 = 0 & a1 = 0 & a2 = 0 -> (a0'= 1) & (a1'= 1) & (a2'= 1) & (b'=1);
       []   a0 = 1 & a1 = 0 & a2 = 0 -> (a0'= 0) & (a1'= 1) & (a2'= 1) & (b'=1);
       []   a0 = 1 & a1 = 1 & a2 = 0 -> (a0'= 0) & (a1'= 0) & (a2'= 1) & (b'=1);
       []   a0 = 1 & a1 = 1 & a2 = 1 -> (a0'= 0) & (a1'= 0) & (a2'= 0) & (b'=1);
